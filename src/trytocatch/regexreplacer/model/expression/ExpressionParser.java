...
import trytocatch.regexreplacer.model.expression.utils.node.DynamicReference;
import trytocatch.regexreplacer.model.expression.utils.node.GetAbsRowNumFunc;
import trytocatch.regexreplacer.model.expression.utils.node.GroupFunc;
import trytocatch.regexreplacer.model.expression.utils.node.MergeFunc;
import trytocatch.regexreplacer.model.expression.utils.node.ReferenceFunc;
import trytocatch.regexreplacer.model.expression.utils.node.SequenceFunc;
import trytocatch.regexreplacer.model.expression.utils.node.StaticReference;
